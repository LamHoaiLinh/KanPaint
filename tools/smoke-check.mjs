...
for(const token of ['_kanPaintRetouch','_commitRetouchLayer','invertMask','showCompareSplit','Script Library','Export Layers','API_VERSION','Batch Runner','KanPaint Guide','Game Asset']){
